...
export type CreateQuotationMutationResponse = { __typename?: 'Mutation' } & {
  createQuotation: { __typename?: 'QuotationEntity' } & Pick<
...
export function useCreateQuotationMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateQuotationMutationResponse, CreateQuotationMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateQuotationMutationResponse, CreateQuotationMutationVariables>(
...
export type CreateQuotationMutationOptions = Apollo.BaseMutationOptions<
  CreateQuotationMutationResponse,
