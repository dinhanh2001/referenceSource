      ...
      if (data != null) {
        switch (data.objectType) {
          case NotificationTypeEnum.ORDER:
            navigation.navigate('e-commerce/my-order-detail', { orderId: data.objectId as string });
            break;

          case NotificationTypeEnum.BOOKING:
            navigation.navigate('my-repair-request/detail', { bookingId: data.objectId as string });
            break;

          case NotificationTypeEnum.MAINTENANCE:
            navigation.navigate('maintenance/detail', { maintenanceId: data.objectId as string });
            break;
