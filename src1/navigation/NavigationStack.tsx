...
import { ViewCus, notificationPermisson } from 'components';
import LottieView from 'lottie-react-native';
import { StatusBar, Image } from 'react-native';
import MessageDetail from 'screens/Message/MessageDetail';
import QRCode from 'screens/MainTab/Home/Screens/QRCode/QRCode';
import { DeliveryProvince } from 'screens';
...
const TABAR_SCREEN = [
  ...
  {
    screen: Routes.Games,
    component: Screens.Games,
    textLabel: 'bottom.games',
    icon: Images.bottomGift,
  },
  {
  ...
  useLayoutEffect(() => {
    ...
    (async () => {
      ...
      if (isCheckIntro === 'Y') {
        ...
        // );
        setInititalRoute(Routes.HomeTabs);
        return true;
      }
