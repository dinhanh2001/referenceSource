...
export const NOTI_LIST = [
  {
    content:
      'Cập nhật tính năng mới của GoLadi để quản lý nhà hàng dễ dàng hơn',
    image: Images.Notification,
  },
  {
    content: 'Tính năng mới của GoLadi để quản lý nhà hàng dễ dàng hơn',
    image: Images.Notification,
  },
  {
    content:
...
export const slidesIntro: IIntroSilde[] = [
  {
    index: 1,
    image: Images.newIntro1,
    title: 'intro.title_1',
    subtitle: 'intro.subtitle_1',
  },
  {
    index: 2,
    image: Images.newIntro2,
    title: 'intro.title_2',
    subtitle: 'intro.subtitle_2',
  },
  {
    index: 3,
    image: Images.newIntro3,
    title: 'intro.title_3',
