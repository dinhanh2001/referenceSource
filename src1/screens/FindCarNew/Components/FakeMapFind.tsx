...
import { MapViewCus, TextCus, ViewCus } from 'components';
...
export const FakeMapFind = ({
  ...
  const GOOGLE_MAPS_API_KEY = Config.GOOGLE_PLACES_KEY;
  useEffect(() => {
    let rs = 0;
  ...
  const renderListBikerRandom = useMemo(() => {
    ...
    return <></>;
  }, [locationUser, type, stepView, locationInit, marker]);
    ...
    <MapViewCus
      ...
      {locationUser ? (
        <Marker
          ...
          <Icon.SpotLightCircle width={64} height={76} />
          <ViewCus
            style={{
            ...
            {fromToData?.from?.address && (
              <TextCus
                ...
                {fromToData?.from?.address.slice(0, 30)}
                ...{' '}
              </TextCus>
            )}
          </ViewCus>
        ...
        <Marker
          ...
          <ViewCus
            ...
            <TextCus
              ...
              {fromToData?.to?.address.slice(0, 30)}
              ...{' '}
            </TextCus>
          </ViewCus>
        </Marker>
