...
import { ArrowLeftSVG, Location } from '../../../svg';
...
import { AddressStackScreenNavigationProps, AddressStackScreenRouteProps } from '../../../navigator-params';
import { showFlashMessageError } from '../../../helpers';
import { useGetPlaceDetailLazyQuery } from '../../../graphql/mutations/getPlaceDetail.generated';
...
export const AddressAutoCompleteScreen = memo(() => {
  ...
  const { params } = useRoute<AddressStackScreenRouteProps<'ADDRESS_AUTOCOMPLETE'>>();
              ...
              onPress={() =>
                getPlace({
                  ...
                  onCompleted: async (res) => {
                    ...
                    navigation.navigate('ADDRESS_MAP', {
